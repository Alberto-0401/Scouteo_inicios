...
public class EstadisticasJugadorController {
    ...
    private Integer equipoActivoId;
    ...
    private void abrirFormularioEdicion(EstadisticaPartidoVista vista) {
        ...
        for (JugadorPartido jp : participaciones) {
            ...
            if (partido != null && partido.getFechaHora().toString().equals(vista.getFecha())
    ...
    public void setEquipoActivo(com.javafx.scouteo.model.Equipo equipo) {
        this.equipoActivoId = (equipo != null) ? equipo.getId() : null;
        cargarJugadores();
    }

    private void cargarJugadores() {
        if (equipoActivoId != null) {
            listaJugadores = jugadorDAO.obtenerActivosPorEquipo(equipoActivoId);
        } else {
