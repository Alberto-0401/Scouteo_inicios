...
public class ConfiguracionController {
    ...
    private void cargarDatos() {
        ...
        configuracion = configuracionDAO.obtener(clubId);
        esNueva = (configuracion == null);
    ...
    void guardarCambios(ActionEvent event) {
        ...
        if (configuracion == null) {
            ...
            configuracion.setClubId(clubId);
        }
        ...
        boolean exito = esNueva
                ? configuracionDAO.inicializar(configuracion)
                : configuracionDAO.actualizar(configuracion);
        if (exito) esNueva = false;
